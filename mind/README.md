# MIND - Sistema de Gestión de Salud Mental
...
**Terminal 1 - Backend (Microservicio de Usuarios):**
```powershell
cd mind\mind
npm install
npm run dev:users
...
**Nota:** Después de cambiar el estado de JWT, reinicia los microservicios para aplicar los cambios.
...
```
mind/
├── mind-frontend/              # Aplicación móvil/web (Expo React Native)
...
│   │   ├── agendamiento.tsx
│   │   ├── diarioEmocional.tsx
│   │   ├── diarioEmocional_final.tsx
│   │   ├── diarioEmocional_new.tsx
│   │   ├── eventos.tsx
│   │   ├── forgotPassword.tsx
│   │   ├── home.tsx
│   │   ├── index.tsx
...
│   │   │   ├── accesoController.js
│   │   │   ├── accesoUsuarioController.js
│   │   │   ├── administracionAuditoriaController.js
│   │   │   ├── ciudadController.js
│   │   │   ├── departamentoController.js
│   │   │   ├── estadoController.js
│   │   │   ├── imagenSistemaController.js
│   │   │   ├── menuController.js
│   │   │   ├── notificacionController.js
│   │   │   ├── paisController.js
│   │   │   ├── suscripcionController.js
│   │   │   ├── tipoNotificacionController.js
│   │   │   ├── tipoSuscripcionController.js
│   │   │   ├── tipoVariableController.js
│   │   │   └── variableController.js
│   │   ├── routes/             # Rutas de API
│   │   │   ├── accesoRoutes.js
│   │   │   ├── accesoUsuarioRoutes.js
│   │   │   ├── administracionAuditoriaRoutes.js
│   │   │   ├── ciudadRoutes.js
│   │   │   ├── departamentoRoutes.js
│   │   │   ├── estadoRoutes.js
│   │   │   ├── imagenSistemaRoutes.js
│   │   │   ├── menuRoutes.js
│   │   │   ├── notificacionRoutes.js
│   │   │   ├── paisRoutes.js
│   │   │   ├── suscripcionRoutes.js
│   │   │   ├── tipoNotificacionRoutes.js
│   │   │   ├── tipoSuscripcionRoutes.js
│   │   │   ├── tipoVariableRoutes.js
│   │   │   └── variableRoutes.js
│   │   └── server.js
│   │
│   ├── agenda/
│   │   ├── controllers/
│   │   │   ├── agendaAuditoriaController.js
│   │   │   ├── agendaController.js
│   │   │   ├── agendaDiaController.js
│   │   │   ├── citaContenidoController.js
│   │   │   ├── citaController.js
│   │   │   ├── citaDiagnosticoController.js
│   │   │   ├── registroCitaController.js
│   │   │   ├── seguimientoController.js
│   │   │   ├── tipoAgendaController.js
│   │   │   └── tipoDiagnosticoController.js
│   │   ├── routes/
│   │   │   ├── agendaAuditoriaRoutes.js
│   │   │   ├── agendaDiaRoutes.js
│   │   │   ├── agendaRoutes.js
│   │   │   ├── citaContenidoRoutes.js
│   │   │   ├── citaDiagnosticoRoutes.js
│   │   │   ├── citaRoutes.js
│   │   │   ├── registroCitaRoutes.js
│   │   │   ├── seguimientoRoutes.js
│   │   │   ├── tipoAgendaRoutes.js
│   │   │   └── tipoDiagnosticoRoutes.js
│   │   └── server.js
│   │
│   ├── emocional/
│   │   ├── controllers/
│   │   │   ├── diarioAuditoriaController.js
│   │   │   ├── diarioController.js
│   │   │   ├── diarioEmocionController.js
│   │   │   ├── diarioSensacionController.js
│   │   │   ├── diarioSentimientoController.js
│   │   │   ├── diarioSintomaController.js
│   │   │   ├── emocionController.js
│   │   │   ├── sensacionController.js
│   │   │   ├── sentimientoController.js
│   │   │   ├── sintomaController.js
│   │   │   └── tipoEmocionController.js
│   │   ├── routes/
│   │   │   ├── diarioAuditoriaRoutes.js
│   │   │   ├── diarioEmocionRoutes.js
│   │   │   ├── diarioRoutes.js
│   │   │   ├── diarioSensacionRoutes.js
│   │   │   ├── diarioSentimientoRoutes.js
│   │   │   ├── diarioSintomaRoutes.js
│   │   │   ├── emocionRoutes.js
│   │   │   ├── sensacionRoutes.js
│   │   │   ├── sentimientoRoutes.js
│   │   │   ├── sintomaRoutes.js
│   │   │   └── tipoEmocionRoutes.js
│   │   └── server.js
│   │
│   └── usuarios/
│       ├── controllers/
│       │   ├── authController.js
│       │   ├── informacionPagoController.js
│       │   ├── personaController.js
│       │   ├── suscripcionUsuarioController.js
│       │   ├── tipoUsuarioController.js
│       │   ├── usuarioAuditoriaController.js
│       │   └── usuarioController.js
│       ├── routes/
│       │   ├── authRoutes.js
│       │   ├── informacionPagoRoutes.js
│       │   ├── personaRoutes.js
│       │   ├── suscripcionUsuarioRoutes.js
│       │   ├── tipoUsuarioRoutes.js
│       │   ├── usuarioAuditoriaRoutes.js
│       │   └── usuarioRoutes.js
│       ├── services/
│       └── server.js
│
...
│           ├── InformacionPago.js
│           ├── Persona.js
│           ├── SuscripcionUsuario.js
│           ├── TipoUsuario.js
│           ├── Usuario.js
│           └── UsuarioAuditoria.js
│
├── scripts/                    # Scripts de utilidades
│   ├── create-fresh-superadmin.js
│   ├── fix-verified-users-state.js
│   ├── jwt-toggle.js
│   ├── reset-superadmin-password.js
│   ├── seed-default-menus.js
│   ├── seed-superadmin.js
│   ├── seed-tipos-emocion.js
│   ├── test-hashing.js
│   ├── test-login.js
│   └── verify-password.js
│
...
Gestión de usuarios, autenticación, personas y suscripciones.

### Microservicio Administrativo (Puerto 3001)
Datos geográficos, configuración del sistema, menús, notificaciones y control de accesos.

### Microservicio Emocional (Puerto 3003)
Diarios emocionales, seguimiento de emociones, sensaciones, síntomas y sentimientos.

### Microservicio Agenda (Puerto 3004)
Gestión de citas, agendas, diagnósticos y seguimiento de pacientes.
